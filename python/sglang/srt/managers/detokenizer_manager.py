...
class DetokenizerManager(MultiHttpWorkerDetokenizerMixin):
    ...
    def handle_batch_token_id_out(self, recv_obj: BatchTokenIDOutput):
        ...
        return BatchStrOutput(
            ...
            spec_time_forward_target_extend=recv_obj.spec_time_forward_target_extend,
            spec_time_forward_draft_extend=recv_obj.spec_time_forward_draft_extend,
            spec_avg_time_draft=recv_obj.spec_avg_time_draft,
            spec_avg_time_verify=recv_obj.spec_avg_time_verify,
            spec_time_forward_draft_extend_after_decode=recv_obj.spec_time_forward_draft_extend_after_decode,
